...
def test_record_maps_loki_event_without_raw_ip() -> None:
    record = _record(
        ...
        '{"status":200,"size":12,"request":{"method":"GET","uri":"/feed.xml","headers":{"Cf-Connecting-Ip":["8.8.8.8"]}}}',
    )
...
def test_record_uses_country_code_label_and_cf_ipcountry() -> None:
    ...
    from_header = _record(
        datetime(2026, 9, 3, tzinfo=UTC),
        {"service_name": "barbero-scripts/caddy"},
        '{"status":200,"size":12,"request":{"method":"GET","uri":"/feed.xml","headers":{"Cf-Connecting-Ip":["8.8.8.8"],"Cf-Ipcountry":["DE"]}}}',
    )
